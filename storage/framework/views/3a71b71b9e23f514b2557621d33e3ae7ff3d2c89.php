                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            ...
                            <?php if(Route::has('register')): ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('register')); ?>"><?php echo e(__('ユーザー登録')); ?></a>
                                </li>
                            <?php endif; ?>
                        <?php else: ?>
...
<?php /**PATH /home/ec2-user/environment/blog/resources/views/layouts/app.blade.php ENDPATH**/ ?>